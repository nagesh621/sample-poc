 ...
 * #57 - previous fix didn't really work, sockjs-workflow still left
 ...
 * #49 - support SockJS-workflow being used from files served from
   file:// urls.
 ...
 * #34 - Don't ever reuse `session_id`, especially when trying
   fallback protocols.
 * The test server got moved from SockJS-workflow to SockJS-node.
 ...
 * SockJS-workflow can only send UTF-8 encodable strings.  Previously we
