...
[![npm version](https://img.shields.io/npm/v/sockjs-workflow.svg?style=flat-square)](https://www.npmjs.com/package/sockjs-workflow)[![Build Status](https://img.shields.io/travis/sockjs/sockjs-workflow/main.svg?style=flat-square)](https://travis-ci.org/sockjs/sockjs-workflow)[![Dependencies](https://img.shields.io/librariesio/release/npm/sockjs-workflow.svg?style=flat-square)](https://libraries.io/npm/sockjs-workflow)[![Chat](https://img.shields.io/badge/Chat-gitter.im-blue.svg?style=flat-square)](https://gitter.im/sockjs/sockjs-workflow)[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v2.0%20adopted-ff69b4.svg?style=flat-square)](CODE_OF_CONDUCT.md)
...
The maintainers of SockJS and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-sockjs-workflow?utm_source=npm-sockjs-workflow&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)
...
SockJS-workflow does require a server counterpart:
...
# SockJS family
  ...
  * [SockJS-workflow](https://github.com/sockjs/sockjs-workflow) JavaScript workflow library
  ...
  * [Spring Framework](https://projects.spring.io/spring-framework) Java [workflow](https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/web.html#websocket-fallback-sockjs-workflow) & server
...
Work in progress:
  ...
  * [syp.biz.SockJS.NET](https://github.com/sypbiz/SockJS.NET) - .NET port of the SockJS workflow
...
```html
<script src="https://cdn.jsdelivr.net/npm/sockjs-workflow@1/dist/sockjs.min.js"></script>
```
 ...
 *  **sessionId (number OR function)**
    ...
    Both workflow and server use session identifiers to distinguish connections.
...
# Connecting to SockJS without the workflow
...
You can connect any WebSocket RFC 6455 compliant WebSocket workflow to
this url. This can be a command line workflow, external application,
...
You should use a version of sockjs-workflow
...
SockJS-workflow needs [node.js](https://nodejs.org/) for running a test
server and JavaScript minification. If you want to work on
SockJS-workflow source code, checkout the git repo and follow these
steps:
...
Once you've compiled the SockJS-workflow you may want to check if your changes
pass all the tests.
 ...
 * Pressing ESC in Firefox, before Firefox 20, closes the SockJS connection. For a workaround
   and discussion see [#18](https://github.com/sockjs/sockjs-workflow/issues/18).
 ...
 * SockJS [websocket transport is more stable over SSL](https://github.com/sockjs/sockjs-workflow/issues/94). If
