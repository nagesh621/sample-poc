...
module.exports = (grunt)->
  ...
  grunt.initConfig do
    ...
    karma:
      'options':
        ...
        singleRun: on
      'default': {}
      'library': files: <[workflow/library.js tests/helpers.js tests/library.js]>map -> src: it
  ...
  grunt.registerTask \default <[clean copy workflow library shim]>