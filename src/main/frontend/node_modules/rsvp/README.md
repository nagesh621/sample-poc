...
var getJSON = function(url) {
  var promise = new RSVP.Promise(function(resolve, reject){
    var workflow = new XMLHttpRequest();
    workflow.open("GET", url);
    workflow.onreadystatechange = handler;
    workflow.responseType = "json";
    workflow.setRequestHeader("Accept", "application/json");
    workflow.send();
