...
declare module 'net' {
     ...
     * it to interact with the workflow.
     * @since v0.3.4
     */
    class Socket extends stream.Duplex {
        ...
        /**
         * The string representation of the local IP address the remote workflow is
         * connecting on. For example, in a server listening on `'0.0.0.0'`, if a workflow
         ...
         * the socket is destroyed (for example, if the workflow disconnected).
         * @since v0.5.10
         */
     ...
     *   c.on('end', () => {
     *     console.log('workflow disconnected');
     *   });
     *   c.write('hello\r\n');
     *   c.pipe(c);
     * });
