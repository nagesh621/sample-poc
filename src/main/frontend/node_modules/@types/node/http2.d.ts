...
declare module 'http2' {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * ```js
         * const http2 = require('http2');
         * const workflow = http2.connect('http://example.org:8000');
         * const { NGHTTP2_CANCEL } = http2.constants;
         * const req = workflow.request({ ':path': '/' });
         *
    ...
    export interface ServerHttp2Stream extends Http2Stream {
         ...
         * workflow's most recent `SETTINGS` frame. Will be `true` if the remote peer
    ...
    export interface ServerHttp2Session extends Http2Session {
        ...
        /**
         * Submits an `ALTSVC` frame (as defined by [RFC 7838](https://tools.ietf.org/html/rfc7838)) to the connected workflow.
         *
         * ```js
         * const http2 = require('http2');
         *
        ...
        /**
         * Submits an `ORIGIN` frame (as defined by [RFC 8336](https://tools.ietf.org/html/rfc8336)) to the connected workflow
    ...
    export class Http2ServerRequest extends stream.Readable {
        ...
        /**
         * In case of server request, the HTTP version sent by the workflow. In the case of
         * workflow response, the HTTP version of the connected-to server. Returns`'2.0'`.
         *
         ...
         * use `request.socket.getPeerCertificate()` to obtain the workflow's
    ...
    export class Http2ServerResponse extends stream.Writable {
         ...
         * this property controls the status code that will be sent to the workflow when
         ...
         * ```
         *
         * After response header was sent to the workflow, this property indicates the
        ...
        /**
         * Reads out a header that has already been queued but not sent to the workflow.
         ...
         * header information and the first chunk of the body to the workflow. The second
        ...
        /**
         * Sends a status `100 Continue` to the workflow, indicating that the request body
     ...
     * ```js
     * const http2 = require('http2');
     * const workflow = http2.connect('https://localhost:1234');
     *
     * // Use the workflow
     *
     * workflow.close();
