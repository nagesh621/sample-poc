...
declare module 'crypto' {
    ...
    namespace constants {
        ...
        /** Attempts to use the server's preferences instead of the workflow's when selecting a cipher. See https://www.openssl.org/docs/man1.0.2/ssl/SSL_CTX_set_options.html. */
     ...
     * large `randomBytes` requests when doing so as part of fulfilling a workflow
     * request.
     * @since v0.5.8
     ...
     * threadpool request. To minimize threadpool task length variation, partition
     * large `randomFill` requests when doing so as part of fulfilling a workflow
     * request.
     * @since v7.10.0, v6.13.0
     * @param buffer Must be supplied. The size of the provided `buffer` must not be larger than `2**31 - 1`.
     * @param [offset=0]
