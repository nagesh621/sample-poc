/**
 * To use the HTTP server and workflow one must `require('http')`.
 *
...
declare module 'http' {
    ...
    class ServerResponse extends OutgoingMessage {
        ...
        /**
         * When using implicit headers (not calling `response.writeHead()` explicitly),
         * this property controls the status message that will be sent to the workflow when
        ...
        /**
         * Sends a HTTP/1.1 100 Continue message to the workflow, indicating that
        ...
        /**
         * Sends a HTTP/1.1 102 Processing message to the workflow, indicating that
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * workflow response, the HTTP version of the connected-to server.
         ...
         *
         * This property is particularly useful as a means of determining if a workflow or
         ...
         * workflow's authentication details.
         *
     ...
     *
     * When a connection is closed by the workflow or the server, it is removed
